...
<h2 align="center">ChatRoomRecorderReborn is an open source project to record Chaturbate, BongaCams, Stripchat, Flirt4Free, CamSoda and Cam4 shows with no limitations!</h2>

This project is based on https://github.com/SagalVanderklok/ChatRoomRecorder, which is currently outdated
...
2. Download and install _Streamlink_ ([x64](https://github.com/streamlink/windows-builds/releases/download/8.4.0-1/streamlink-8.4.0-1-py314-x86_64.exe) or [x86](https://github.com/streamlink/windows-builds/releases/download/6.9.0-1/streamlink-6.9.0-1-py312-x86.exe))
3. Download and unpack **ChatRoomRecorderReborn**
4. Start **ChatRoomRecorderReborn**
...
If you like this application and want it to evolve please consider supporting me

- BTC (BRC20/BTC) bc1q6590aqwt7sywydtz5rx09pcmk20uf9rxweufjl
- ETH (ERC20) 0x0f5E0dD4df9F2E0738dd0A970D82665498CbbD40
